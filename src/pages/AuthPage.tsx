      ...
      <section className="auth-brand-panel">
        ...
        <div className="auth-hero-copy">
          <span className="eyebrow">
            Xác thực không mật khẩu cho tuyển dụng IT
          </span>
          <h1>
            {isLogin
              ? 'Đăng nhập nhanh bằng mã email'
              : 'Tạo tài khoản tuyển dụng đáng tin cậy'}
          </h1>
          <p>
            {isLogin
        ...
        <div className="auth-proof-grid">
          <div>
            <strong>96%</strong>
            <span>CV match cao nhất</span>
          </div>
          <div>
            <strong>1.2k</strong>
            <span>CV trong Talent Pool</span>
          </div>
          <div>
            <strong>98%</strong>
        ...
        <div className="auth-benefits">
          <p>
            <CheckCircle2 size={15} /> Một phương thức chính: Email OTP 6 số
          </p>
          <p>
            <CheckCircle2 size={15} /> Google/GitHub OAuth cho đăng nhập nhanh
          </p>
          <p>
            <CheckCircle2 size={15} /> Ứng viên và nhà tuyển dụng tách không
            gian làm việc sau xác thực
          </p>
        </div>
      </section>
            ...
            <div>
              ...
              <p>
                {isLogin
                  ...
                  : 'Chọn vai trò, điền thông tin cần thiết và xác thực email.'}
              </p>
            </div>
                    ...
                    <div className="form-grid auth-register-grid">
                      {role === 'candidate' ? (
                        <>
                          ...
                          <AuthMiniField
                            label="Khu vực"
                            value="TP. Hồ Chí Minh, Hybrid"
                          />
                          <AuthMiniField
                            label="CV mặc định"
                            value="Frontend Lead CV.pdf"
                          />
                        </>
                      ) : (
                        <>
                          ...
                          <AuthMiniField
                            ...
                            value="Tran Hoang Lan"
                          />
                          <AuthMiniField
                            label="Giấy phép"
                            value="business-license.pdf"
                          />
                        </>
                      )}
                    </div>
              ...
              <>
                <div className="otp-panel">
                  ...
                  <div>
                    ...
                    <span>
                      Mã 6 số đã được gửi tới {email}. Mã hết hạn sau 10 phút.
                    </span>
                  </div>
                </div>
